...
export const OrganisationMemberInviteDialog = ({ trigger, ...props }: OrganisationMemberInviteDialogProps) => {
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@bringspark.com', role: 'Admin' },
      { email: 'manager@bringspark.com', role: 'Manager' },
      { email: 'member@bringspark.com', role: 'Member' },
    ];
    ...
    downloadFile({
      filename: 'bringspark-organisation-member-invites-template.csv',
      data: blob,
    });
  };
