 ...
 * `.bringspark-branded` wrapper rendered in `_recipient+/_layout.tsx`.
 *
 ...
 *   }
 *
 * Equivalent to `.bringspark-branded .my-class { color: red; }` after expansion.
 *
...
export const RecipientBranding = ({ branding, cspNonce }: RecipientBrandingProps) => {
  ...
  const css = `.bringspark-branded { ${innerBody} }`;
