...
export function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // Recipient routes (signing pages) put `bringspark-branded` on <body> so the
  ...
  return (
    ...
    <html translate="no" lang={lang} data-theme={theme} className={theme ?? ''} suppressHydrationWarning>
      ...
      <body className={isRecipientRoute ? 'bringspark-branded' : undefined}>
          ...
          <div className="bg-destructive text-destructive-foreground">
            <div className="mx-auto flex h-auto max-w-screen-xl items-center justify-center px-4 py-3 text-sm font-medium">
              <div className="flex items-center">
                ...
                <Trans>This is an expired license instance of BringSpark</Trans>
              </div>
            </div>
          </div>
        )} */}
