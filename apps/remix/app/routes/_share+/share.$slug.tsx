...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'BringSpark - Share' },
    { description: 'I just signed a document in style with BringSpark!' },
    {
      property: 'og:title',
      content: 'BringSpark - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with BringSpark!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for BringSpark.
  throw redirect('https://bringspark.com');
};
