...
import { BRINGSPARK_INTERNAL_EMAIL } from '@documenso/lib/constants/email';
...
export const sendOrganisationAccountLinkConfirmationEmail = async ({
  ...
  // delivered from trusted BringSpark infrastructure (see the `mailer.sendMail`
  ...
  // Deliberately uses the global BringSpark mailer + internal sender (not the
