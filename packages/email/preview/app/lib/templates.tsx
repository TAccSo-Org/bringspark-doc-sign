...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-invite': {
    ...
    fields: {
      ...
      inviterEmail: { type: 'text', label: 'Inviter email', default: 'lucas@bringspark.com' },
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'https://bringspark.com' },
      rejectionReason: {
        type: 'textarea',
  ...
  'organisation-invite': {
    ...
    fields: {
      ...
      organisationName: { type: 'text', label: 'Organisation name', default: 'BringSpark' },
    },
  },
  'organisation-join': {
  ...
  'confirm-team-email': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'BringSpark' },
    },
  },
  'team-delete': {
    name: 'Team delete',
  ...
  'team-email-removed': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'BringSpark' },
      teamEmail: { type: 'text', label: 'Team email', default: 'team@bringspark.com' },
    },
  },
  ...
  'confirm-email': {
    ...
    fields: {
      confirmationLink: {
        ...
        default: 'https://bringspark.com/confirm',
      },
    },
  },
  'forgot-password': {
    ...
    fields: {
      resetPasswordLink: {
        type: 'text',
        label: 'Reset link',
        default: 'https://bringspark.com/reset',
      },
    },
  },
  'reset-password': {
    ...
    fields: {
      userName: { type: 'text', label: 'User name', default: 'Lucas Smith' },
      userEmail: { type: 'text', label: 'User email', default: 'lucas@bringspark.com' },
    },
  },
  'access-auth-2fa': {
