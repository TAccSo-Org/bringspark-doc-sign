 ...
 * - Otherwise the BringSpark logo is shown.
 */
export const TemplateBrandingLogo = ({ assetBaseUrl, className = 'mb-4 h-6' }: TemplateBrandingLogoProps) => {
  ...
  if (!hasCustomBrandingLogo) {
    const bringSparkLogoUrl = new URL('/static/logo.png', assetBaseUrl).toString();

    return <Img src={bringSparkLogoUrl} alt="BringSpark Logo" className={className} />;
  }
