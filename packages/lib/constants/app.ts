...
export const SUPPORT_EMAIL = env('NEXT_PUBLIC_SUPPORT_EMAIL') ?? 'hello@bringspark.com';
...
/**
 * Whether this BringSpark instance is running in CSC (Cloud Signature Consortium) mode.
 *
