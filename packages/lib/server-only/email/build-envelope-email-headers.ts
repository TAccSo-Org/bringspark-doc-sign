 ...
 * to the originating BringSpark user via the admin panel.
 *
...
export const buildEnvelopeEmailHeaders = ({
  ...
  return {
    'X-BringSpark-Sender-User-Id': String(userId),
    'X-BringSpark-Envelope-Id': envelopeId,
    'X-BringSpark-Team-Id': String(teamId),
  };
};
